...
class Diver extends React.Component {
  static propTypes = {
          ...
          >
            ...
            <g>
              ...
              <use
                fill="#34B2D6"
                overflow="visible"
                xlinkHref={`#a${this.state.idSuffix}`}
              />
              <clipPath id={`b${this.state.idSuffix}`}>
                <use
                  overflow="visible"
                  xlinkHref={`#a${this.state.idSuffix}`}
                />
              ...
              <path
                ...
                clipPath={`url(#b${this.state.idSuffix}`}
                opacity=".56"
              />
              <use
                fill="none"
              ...
              <use
                fill="#8AC5D6"
                overflow="visible"
                xlinkHref={`#c${this.state.idSuffix}`}
              />
              <clipPath id={`d${this.state.idSuffix}`}>
                <use
                  overflow="visible"
                  xlinkHref={`#c${this.state.idSuffix}`}
                />
              ...
              <path
                ...
                clipPath={`url(#d${this.state.idSuffix}`}
                opacity=".46"
              />
              <path
                fill="#438CA1"
              ...
              <path
                ...
                clipPath={`url(#d${this.state.idSuffix}`}
              />
              <g clipPath={`url(#d${this.state.idSuffix}`}>
                <defs>
                  <path
                    id={`e${this.state.idSuffix}`}
                ...
                <use
                  fill="#34B2D6"
                  overflow="visible"
                  xlinkHref={`#e${this.state.idSuffix}`}
                />
                <clipPath id={`f${this.state.idSuffix}`}>
                  <use
                    overflow="visible"
                    xlinkHref={`#e${this.state.idSuffix}`}
                  />
                ...
                <path
                  ...
                  clipPath={`url(#f${this.state.idSuffix}`}
                  opacity=".38"
                />
                <use
                  fill="none"
              ...
              <use
                fill="#8AC5D6"
                overflow="visible"
                xlinkHref={`#g${this.state.idSuffix}`}
              />
              <clipPath id={`h${this.state.idSuffix}`}>
                <use
                  overflow="visible"
                  xlinkHref={`#g${this.state.idSuffix}`}
                />
              ...
              <path
                ...
                clipPath={`url(#h${this.state.idSuffix}`}
              />
              <path
                fill="#FFF"
                stroke="#1D1D1B"
              ...
              <use
                fill="#8AC5D6"
                overflow="visible"
                xlinkHref={`#i${this.state.idSuffix}`}
              />
              <use
                fill="none"
                stroke="#1D1D1B"
              ...
              <use
                fill="#BCCF00"
                overflow="visible"
                xlinkHref={`#j${this.state.idSuffix}`}
              />
              <clipPath id={`k${this.state.idSuffix}`}>
                <use
                  overflow="visible"
                  xlinkHref={`#j${this.state.idSuffix}`}
                />
              ...
              <path
                ...
                clipPath={`url(#k${this.state.idSuffix}`}
              />
              <g clipPath={`url(#k${this.state.idSuffix}`}>
                <path
                  fill="#00C800"
              ...
              <use
                fill="#D0F0FF"
                overflow="visible"
                xlinkHref={`#l${this.state.idSuffix}`}
              />
              <clipPath id={`m${this.state.idSuffix}`}>
                <use
                  overflow="visible"
                  xlinkHref={`#l${this.state.idSuffix}`}
                />
              ...
              <path
                ...
                clipPath={`url(#m${this.state.idSuffix}`}
              />
              <path
                fill="#FFF"
              ...
              <path
                fill="#FFF7A1"
                d="M273.692 285.84s14.792 1.831 11.609-.317"
              />
              <path
                fill="none"
                stroke="#1D1D1B"
            ...
            <g>
              ...
              <use
                fill="#FD0"
                overflow="visible"
                xlinkHref={`#n${this.state.idSuffix}`}
              />
              <clipPath id={`o${this.state.idSuffix}`}>
                <use
                  overflow="visible"
                  xlinkHref={`#n${this.state.idSuffix}`}
                />
              ...
              <path
                ...
                clipPath={`url(#o${this.state.idSuffix}`}
              />
              <use
                fill="none"
                stroke="#1D1D1B"
            ...
            <g>
              ...
              <use
                fill="#9C9B9B"
                overflow="visible"
                xlinkHref={`#p${this.state.idSuffix}`}
              />
              <clipPath id={`q${this.state.idSuffix}`}>
                <use
                  overflow="visible"
                  xlinkHref={`#p${this.state.idSuffix}`}
                />
              ...
              <path
                ...
                clipPath={`url(#q${this.state.idSuffix}`}
              />
              <use
                fill="none"
                stroke="#1D1D1B"
