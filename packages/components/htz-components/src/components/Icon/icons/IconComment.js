...
const IconComment = ({ size, fill, color, attrs, miscStyles, ...props }) => (
  <FelaComponent
    ...
    style={iconStyle}>{({ className, }) => (
      <svg width="1em" height="1em" viewBox="0 0 256 256" className={className} {...props} {...attrs} >  <path fill="currentColor" d="M218.5 178h-43v44.9L116.6 178H37.5V55h181v123z" /></svg>
    )}</FelaComponent>
);
